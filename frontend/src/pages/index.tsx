              ...
              <div>
                ...
                {this.state.AC_state ? (
                  ...
                  <div>
                    ...
                    <br />
                    <p>
                      The AC is off now, please click the button to turn on the
                      AC and have a nice day :)
                    </p>
                    <br />
                    <br />
                    <hr />
              ...
              <div>
                {this.state.is_checked_out ? (
                  ...
                  <div>
                    ...
                    <hr />
                    <p>
                      To use the DCTCS, please check in to get your room and
                      turn on the AC. If you are done with the AC, please make
                      sure it is off and you can check your bill after checkout.
                    </p>
                    <p>
                      <strong>Have a nice day!</strong>
                    </p>
                    <br />
                    <button className="btn" onClick={() => this.check_in()}>
                      Check in
                    </button>
                  </div>
                )}
